...
const ViewGuide = () => {
    ...
    const [guidesPerPage] = useState(1); // Number of hotels per page
    ...
    const handleDelete = async (id) =>{
      ...
      let handleUp=(id)=>{
        navigate(`/agency/updateguide/${id}`)
      }
  ...
  return (
    ...
    <div className='view p-10' >
      ...
      <div className='pgbtn'>
                ...
                <button className='pgbtn2' onClick={() => paginate(currentPage + 1)} disabled={currentPage === Math.ceil(vguideData.length / guidesPerPage)}>
                    Next
                </button>
            </div>
                </div>
